...
const AddGame = () => {
    ...
    return (
        <div className='p-4'>
            <h3>ADD new Game</h3>
            <input type = "text" value={name} onChange={e=>{ setName(e.target.ariaValueNow)}} placeholder = "name" />
            <br />
            <input type = "text" value={desc} onChange={e=>{ setDesc(e.target.ariaValueNow)}} placeholder = "desc" />
            <br />
